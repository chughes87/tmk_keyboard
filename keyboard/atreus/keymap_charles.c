...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP( \
        ...
        KC_LBRC,  KC_RBRC, SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_4),             KC_LEFT,     KC_DOWN,           KC_UP,        KC_RIGHT,         KC_F10,   \
        KC_HOME,  KC_END,  KC_F7, KC_F8,   KC_F9,             KC_F11,    KC_F12,    KC_EQUAL,      SHIFT(KC_DOT) ,        KC_BSLS,          \
        KC_TAB,   KC_LALT,  KC_LCTL,     KC_LGUI, KC_LSFT, KC_FN0, KC_FN1,       KC_LGUI, KC_DEL, KC_F1, KC_GRAVE, KC_F2),\
  ...
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP,                               KC_UP, KC_F7, KC_F8, KC_F9, KC_F10,   \
         ...
         KC_NO, KC__VOLDOWN, KC_LCTL,  KC_LGUI, KC_LSFT, KC_LALT, KC_FN2,       KC_SPC, KC_BSPC, KC_PSCREEN, KC_SLCK, KC_PAUSE)
};
